<x-app>
    ...
    <div class="pt-12">
        ...
        <a target="_blank" class="border-2 uppercase font-bold tracking-wider border-dashed px-4 py-2 hover:border-aoc-green hover:text-aoc-green text-xl text-center inline-flex items-center" href="https://github.com/MarkoKaartinen/advent-of-code-2022">
